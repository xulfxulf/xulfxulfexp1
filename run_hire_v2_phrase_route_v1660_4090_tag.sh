...
OUTPUT_DIR=${OUTPUT_DIR:-/root/autodl-tmp/HIRE_v2_phrase_route_v1660_logs}
...
TRAIN_LABELS=${TRAIN_LABELS:?set TRAIN_LABELS to v16.6.0 phrase labels JSONL}
VAL_SPANS=${VAL_SPANS:-${TEST_SPANS:-}}
TEST_SPANS=${TEST_SPANS:?set TEST_SPANS to TAG test phrase spans JSONL}
EXP_NAME=${EXP_NAME:-hire_v2_phrase_route_v1660_tagpedes_60e_seed${SEED}}
...
"${PYTHON_BIN}" train.py \
  --name "${EXP_NAME}" \
  --hire_v2 \
  --hire_v2_mode identity_phrase_route \
