...
| v006_rstp_backbone_lr | Test base peak LR 1e-5 instead of 1e-6 after train-only gradient diagnosis; all formulas unchanged | Implemented; awaiting four-GPU audit and validation-only training |
