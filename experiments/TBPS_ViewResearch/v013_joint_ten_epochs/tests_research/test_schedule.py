...
class AllocationTests(unittest.TestCase):
    def test_peak_group_rates_and_unchanged_auxiliary_schedule(self):
        ...
        cfg = read_json(Path(__file__).resolve().parents[1] / 'configs/research_v013.json')
        ...
        self.assertGreater(schedule(cfg, 10, 211)[0], 5e-6)
        self.assertLess(schedule(cfg, 10, 211)[0], 5.01e-6)
