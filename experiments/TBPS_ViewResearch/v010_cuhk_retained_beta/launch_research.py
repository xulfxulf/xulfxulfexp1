...
def main():
    ...
    for entry in Path('/proc').iterdir():
        ...
        if 'train.py' in names or ('train' in names and any(x in names for x in ('run_research.py', 'run_view4.py', 'run_rstp_e0.py', 'run_cuhk_e0.py'))):
    ...
    entry = 'run_cuhk_e0.py' if baseline else 'run_research.py'
    ...
    if stage == 'audit':
        command.extend(['--steps', '8' if baseline else '4'])
