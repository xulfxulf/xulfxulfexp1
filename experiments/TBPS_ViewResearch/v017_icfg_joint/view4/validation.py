...
PATH_KEYS = ("dataset_root", "annotation_root", "source_annotation_root", "orientation", "clip_checkpoint", "prepared_dir")
...
def critical_config(cfg):
    ...
    result['input_resolution'] = list(cfg['input_resolution'])
