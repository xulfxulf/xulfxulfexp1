...
from .geometry import INPUT_SIZE, CROP_RATIO
...
class TrainTransform:
    def __init__(self):
        ...
        self.pool = [T.ColorJitter(.1, .1, .1, 0), T.RandomRotation(15),
                     T.RandomResizedCrop(INPUT_SIZE, scale=(.9, 1.), ratio=CROP_RATIO, antialias=True),
...
def eval_transform():
    return T.Compose([T.Resize(INPUT_SIZE, interpolation=T.InterpolationMode.BICUBIC, antialias=True),
