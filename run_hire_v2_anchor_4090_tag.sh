...
OUTPUT_DIR=${OUTPUT_DIR:-logs_4090/HIRE_v2_anchor}
...
EXP_NAME=${EXP_NAME:-hire_v2_anchor_${DATASET_NAME}_60e_seed${SEED}}

if [ "${PRETRAIN_CHOICE}" != "ViT-B/16" ]; then
  echo "HIRE-v2 anchor requires PRETRAIN_CHOICE=ViT-B/16"
  exit 1
fi
